                ...
                <ul class="flex-grow-1 px-3 py-2 space-y-2">
                    ...
                    <li>
                      <button class="toggleButton mt-0 d-block p-2 rounded hover:<?= $current_theme['hover_color'] ?> active:<?= $current_theme['active_color'] ?> <?= $current_theme['text_color'] ?> sidebar-button transition duration-250 ease-in-out"
                        ...
                        <div class="flex items-center justify-between w-full">
                          <span class="flex items-center gap-2">
                            <i class="bi bi-substack me-1"></i> Bloglar
                          </span>
                          <i class="bi bi-chevron-down"></i>
                        </div>
                      </button>
                      <ul class="contentList px-2 space-y-1 <?= $current_theme['sub_color'] ?>" style="max-height: 0; overflow: hidden; transition: max-height 0.5s ease;">
                        <li><a href="/admin/blogkategoriler" class="d-block p-2 mt-1 rounded <?= $currentPath === '/admin/blogkategoriler' ? $current_theme['active_color'] . ' hover:' . $current_theme['active_color'] : 'hover:' . $current_theme['hover_color'] . ' active:' . $current_theme['active_color'] ?> <?= $current_theme['text_color'] ?> sidebar-button transition duration-250 ease-in-out">Blog Kategorileri</a></li>
                        <li><a href="/admin/bloglar" class="d-block p-2 mb-1 rounded <?= $currentPath === '/admin/bloglar' ? $current_theme['active_color'] . ' hover:' . $current_theme['active_color'] : 'hover:' . $current_theme['hover_color'] . ' active:' . $current_theme['active_color'] ?> <?= $current_theme['text_color'] ?> sidebar-button transition duration-250 ease-in-out">Blog Yazıları</a></li>
                      </ul>
                    </li>
                    <li>
